...
class PreviewRequest(BaseModel):
    client_id: str
    # Flow-specific addressing, as built: {"return_id": ...} for gstr1, gstr3b,
    # gstr9 and tds, {"filing_id": ...} for itr and mca, {"run_id": ...} for pf
    # and esi. Each flow module documents and validates what it needs.
