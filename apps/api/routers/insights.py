...
@router.get("")
def list_insights(client_id: str | None = None, status: str | None = None, current_user: dict = Depends(rbac("report", "read"))):
...
def update_insight_status(insight_id: str, new_status: str, current_user: dict = Depends(rbac("report", "write"))):
