...
const STATUS_CONFIG: Record<TDSReturnStatus, { label: string; color: string }> = {
  ...
  prepared:    { label: "Prepared",    color: "bg-state-working-surface text-state-working" },
  ca_approved: { label: "CA Approved", color: "bg-state-ready-surface text-state-ready" },
  filed:       { label: "Filed",       color: "bg-state-ready-surface text-state-ready" },
