...
export default function ClientRootPage() {
  ...
  useEffect(() => {
    ...
    if (id && id !== "_placeholder") {
      // A bare /clients/{id} link (e.g. from the client list) always lands
      // on Overview. An explicit deep link straight to a section (e.g.
      // /clients/{id}/sales/) never reaches this page at all, so it's
      // unaffected.
