                ...
                {documents.map((doc) => {
                  ...
                  return (
                    <tr key={doc.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 py-3 text-xs text-gray-500 font-mono max-w-[200px] truncate">
                        {doc.file_name}
                      </td>
      ...
      {versionPromptDoc && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm p-6 space-y-4">
            ...
            <div className="flex gap-3 justify-end">
              <button onClick={() => setVersionPromptDoc(null)} className="text-xs px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50">
                Cancel
              </button>
              <button
