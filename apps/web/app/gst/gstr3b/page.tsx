  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">GSTR-3B Review</h1>
        ...
        <>
          ...
          <section className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-5 py-3 bg-gray-50 border-b border-gray-200">
              ...
              <p className="text-xs text-gray-500 mt-0.5">Net of credit notes. CGST Act Section 37.</p>
            </div>
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-50">
                <tr className="hover:bg-gray-50">
                  <td className="px-5 py-3 text-gray-700">Taxable supplies (B2B + B2C + B2CL)</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-900">{r(w.outward.taxable_igst_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-900">{r(w.outward.taxable_cgst_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-900">{r(w.outward.taxable_sgst_paise)}</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-5 py-3 text-gray-700">Zero-rated supplies (Exports / SEZ)</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500">{r(w.outward.zero_rated_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-400">—</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-400">—</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-5 py-3 text-gray-700">Nil-rated / Exempt</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500">{r(w.outward.nil_exempt_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-400">—</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-400">—</td>
                </tr>
          ...
          <section className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-5 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-gray-800 text-sm">Table 4 — ITC Available</h3>
                <p className="text-xs text-gray-500 mt-0.5">CGST Rule 36(4): capped at 105% of GSTR-2A credit.</p>
              </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-50">
                <tr className="hover:bg-gray-50">
                  <td className="px-5 py-3 text-gray-600 text-xs">As per books (purchase register)</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500 text-xs">{r(w.itc.book_igst_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500 text-xs">{r(w.itc.book_cgst_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500 text-xs">{r(w.itc.book_sgst_paise)}</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-5 py-3 text-gray-600 text-xs">As per GSTR-2A (supplier-filed)</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500 text-xs">{r(w.itc.gstr2a_igst_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500 text-xs">{r(w.itc.gstr2a_cgst_paise)}</td>
                  <td className="px-5 py-3 text-right font-mono text-gray-500 text-xs">{r(w.itc.gstr2a_sgst_paise)}</td>
                </tr>
          ...
          <section className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-5 py-3 bg-gray-50 border-b border-gray-200">
              <h3 className="font-semibold text-gray-800 text-sm">Table 6 — Net Tax Payable</h3>
              <p className="text-xs text-gray-500 mt-0.5">CGST Act Section 49: IGST ITC cross-utilised against CGST/SGST if excess.</p>
            </div>
            <div className="grid grid-cols-4 divide-x divide-gray-100 text-center">
              {[
                ...
                { label: "CGST", value: w.net_payable.cgst_paise, color: "text-indigo-700" },
          ...
          <section className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-5 py-3 bg-gray-50 border-b border-gray-200">
              <h3 className="font-semibold text-gray-800 text-sm">GSTN Payload Preview</h3>
              <p className="text-xs text-gray-500 mt-0.5">
                This is the JSON that will be uploaded to gst.gov.in after CA approval.
              </p>
            </div>
            <pre className="p-5 text-xs font-mono text-gray-600 overflow-auto max-h-80 bg-gray-50">
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-900">Mark GSTR-3B as Filed</h3>
