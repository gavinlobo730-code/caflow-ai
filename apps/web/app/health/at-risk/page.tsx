  ...
  return (
    <div className="p-6 space-y-5 bg-[#F8FAFC] min-h-full">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#182350]">At-Risk Clients</h1>
          <p className="text-sm text-gray-500">Health score 40–59 — monitor closely</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <Card className="bg-white border-gray-200 shadow-sm"><CardContent className="py-12 text-center"><p className="text-sm text-gray-500">No at-risk clients</p></CardContent></Card>
      ) : (
