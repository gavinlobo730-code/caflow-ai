...
function gradeBadge(g: Grade) { const m: Record<Grade, string> = { A: "bg-green-800 text-green-300", B: "bg-blue-800 text-blue-300", C: "bg-yellow-800 text-yellow-300", D: "bg-orange-800 text-orange-300", F: "bg-red-800 text-red-300" }; return m[g] ?? "bg-gray-700 text-gray-300"; }
  ...
  return (
    <div className="p-6 space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base font-semibold text-white">At-Risk Clients</h1>
          <p className="text-xs text-slate-400">Health score 40–59 — monitor closely</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <Card className="bg-gray-800 border-gray-700"><CardContent className="py-12 text-center"><p className="text-sm text-slate-500">No at-risk clients</p></CardContent></Card>
      ) : (
