...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ps-bg px-6 py-12">
        ...
        <div className="bg-white rounded-2xl border border-ps-border shadow-sm p-8">
          {sent ? (
            ...
            <>
              ...
              {error && (
                <div role="alert" className="flex items-start gap-2.5 p-3.5 rounded-lg bg-state-problem-surface border border-state-problem-border mb-5">
