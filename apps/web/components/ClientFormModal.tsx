        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              <label className="block text-xs font-medium text-gray-700 mb-1">Client / Business Name *</label>
              <input
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">GST Filing Frequency</label>
              <select
