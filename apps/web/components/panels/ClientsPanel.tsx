  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 border-b border-[#E2E8F0] shrink-0">
        <p className="text-[13px] font-semibold text-[#1E293B]">Clients</p>
        <p className="text-[11px] text-[#94A3B8] mt-0.5">Client management</p>
      </div>

      {/* Search shortcut */}
      <div className="px-2 py-2 border-b border-[#E2E8F0] shrink-0">
        <button
          onClick={onOpenSearch}
          className="flex items-center gap-2 w-full px-2.5 py-1.5 rounded-[7px] bg-[#F8FAFC] border border-[#E2E8F0] text-[12px] text-[#94A3B8] hover:text-[#64748B] hover:bg-[#F1F5F9] transition-all duration-75"
        >
