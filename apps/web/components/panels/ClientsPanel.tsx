  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 border-b border-white/10 shrink-0">
        <p className="text-[13px] font-semibold text-white">Clients</p>
        <p className="text-[11px] text-slate-500 mt-0.5">Client management</p>
      </div>
      ...
      <div className="px-2 py-2 border-b border-white/10 shrink-0">
        <button
          ...
          className="flex items-center gap-2 w-full px-2.5 py-1.5 rounded-[7px] bg-[#F8FAFC] border border-white/10 text-[12px] text-slate-500 hover:text-slate-400 hover:bg-[#F1F5F9] transition-all duration-75"
        >
      ...
      <nav className="flex-1 overflow-y-auto py-2 px-2">
        ...
        <div className="mt-4 mx-2 p-2.5 rounded-[7px] bg-[#F1F5F9] border border-white/10">
