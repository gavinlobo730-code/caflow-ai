  ...
  return (
    <div className="flex flex-col h-full text-white">
      ...
      <div className="flex items-center gap-2 px-4 py-4 border-b border-white/10 shrink-0">
        <div className="w-6 h-6 rounded-md bg-cyan-600/30 flex items-center justify-center">
          <Network size={12} className="text-cyan-400" />
        </div>
        <div>
          <p className="text-[12px] font-semibold text-white leading-none">Relationships</p>
          <p className="text-[10px] text-slate-400 mt-0.5 leading-none">Entity intelligence</p>
        </div>
      </div>
