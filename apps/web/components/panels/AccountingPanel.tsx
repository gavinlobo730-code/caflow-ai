  ...
  return (
    <div className="flex flex-col h-full text-white">
      ...
      <div className="flex items-center gap-2 px-4 py-4 border-b border-white/10 shrink-0">
        ...
        <div>
          <p className="text-[12px] font-semibold text-white leading-none">Accounting</p>
          <p className="text-[10px] text-slate-400 mt-0.5 leading-none">Firm administration</p>
        </div>
      </div>
