  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 border-b border-white/10 shrink-0">
        <p className="text-[13px] font-semibold text-white">Compliance</p>
        <p className="text-[11px] text-slate-500 mt-0.5">Deadline overview</p>
      </div>
      ...
      <div className="mx-2 mt-2 shrink-0">
        <div className="flex items-start gap-2 p-2.5 rounded-[7px] bg-amber-50 border border-amber-500/20">
          <Lock size={11} className="text-amber-600 mt-0.5 shrink-0" />
