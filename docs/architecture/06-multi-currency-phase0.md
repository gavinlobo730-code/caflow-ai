...
- **Phase 5:** FX reporting — foreign TB / BS / P&L, presentation currency, translation reserve (OCI/FCTR), cash-flow FX line; foreign-bank-balance revaluation once `bank_accounts.currency` exists.
