...
| **T3** | Design system + 2 reference screens | 🔧 C | 11–13d | `DOING` — T3-a, T3-b, T3-f done; T3-c 3 of 6 (money cell, Dr/Cr, gap callout) 18 Sep |
...
| T3-c | The 6 product-specific components | 3.5d | 3 of 6 done — below |
