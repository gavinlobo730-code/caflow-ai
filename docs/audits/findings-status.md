...
|---|---|---|
| closed | **43** | re-read against the code. The defect is gone. |
| closed_by_commit | **179** | named in a merged commit on `main` and NOT re-read. Usually fixed; occasionally only cited as background. |
| partial | **11** | part of the finding is answered, part is not. Each says which. |
| open | **29** | re-read and still true. |
| unverified | **15** | a probe was inconclusive. Treat as unknown, **not** as open. |
...
**The work left is about 55 items — 29 open, 11 partial,
15 unverified — not 254.** The audit documents were never amended as
