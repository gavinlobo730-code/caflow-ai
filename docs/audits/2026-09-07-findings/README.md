...
Machine-readable output of the nine subsystem readers behind
...
those verdicts, keyed by finding id. Seventeen of the twenty-one CRITICAL findings
were separately reproduced by hand — see §4 of the report. Everything else is a lead
with evidence, not a settled defect.
...
| `fixed-assets-and-inventory.json` | Fixed assets and inventory | C | 30 |
...
practice management, the AI layer, portals and identity, platform and security,
the frontend as a whole, the marketing site.
